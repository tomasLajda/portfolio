...
const Contact = () => {
	...
	return (
		<Wrapper
			...
			id="Contact"
		>
			<h1 className="pb-8 text-5xl text-center sm:text-left font-bold bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
				Contact
			</h1>
			<Form {...form}>
